...
public class EnsnaringStrike extends BaseCard {

    public static final String ID = makeID(EnsnaringStrike.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
