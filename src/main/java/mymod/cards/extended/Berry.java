...
public class Berry extends BaseCard {

    public static final String ID = makeID(Berry.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
